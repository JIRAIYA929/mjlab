"""RL configuration for Own velocity task."""
...
def own_ppo_runner_cfg() -> RslRlOnPolicyRunnerCfg:
  """Create RL runner configuration for Own velocity task."""
